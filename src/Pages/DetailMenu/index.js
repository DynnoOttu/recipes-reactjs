            ...
            <div className="row">
                <div className="col-sm-12">
                    ...
                    <div className="image text-center">
                        <img src={chiken} className="rounded" alt="..." style={{width: "600px",
                        height: "600px"}}/>
                      </div>
                </div>
            </div>
                    ...
                    <div className="col-sm-10 mt-4">
                        <div className="row">
                            <div className="col-sm-4" style={{display: "flex", alignItems: "center"}}>
                                ...
                                <div className="" style={{width: "3px", height: "70px",
                                backgroundColor: "var(--yellow)",
                                marginLeft: "40px",
                                marginTop: "1px"}}></div>
                            </div>
                ...
                <div className="row">
                    <div className="col-sm-4">
                        <div className="form-floating">
                            ...
                            <button type="button" className="btn btn-danger mt-3" style={{width: "300px",
                            height: "46px", backgroundColor: "#FFB167", border: "none"}}>Send a comment</button>
                          </div>
                    </div>
                </div>     
            </div>
